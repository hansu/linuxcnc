...
- _MIN_SPINDLE_0_OVERRIDE = 0.8_ and _MAX_SPINDLE_0_OVERRIDE = 1.2_ - Will allow you to change the spindle override within a limit from 80% to 120%.
+
[NOTE]
...
- _DEFAULT_SPINDLE_0_SPEED_ - Start value for <<gmoccapy-settings-spindle,"Starting RPM">> if value not present in preferences file or file is not present. Will have no effect with a valid preferences file. Defaults to 200.
- _MIN_SPINDLE_0_SPEED_ - Start value for <<gmoccapy-settings-spindle,"Spindle bar min">> if value not present in preferences file or file is not present. Will have no effect with a valid preferences file. Defaults to 100.
- _MAX_SPINDLE_0_SPEED_ - Start value for <<gmoccapy-settings-spindle,"Spindle bar max">> if value not present in preferences file or file is not present. Will have no effect with a valid preferences file. Defaults to 2500.
...
+
[NOTE]
This value will be presetted according to your settings in `[DISPLAY] DEFAULT_SPINDLE_0_SPEED` of your INI file.
If you change the settings on the settings page, that value will be used from that moment, your INI file will not be modified.
