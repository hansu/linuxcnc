...
# =============================================================
    ...
    def _update_gcodeview_font_filter(self):
        self.widgets.fontbutton_gcodeview.set_filter_func(self._filter_gcodeview_font, self.widgets.chk_font_monospace.get_active(), self.widgets.chk_font_regular.get_active())
