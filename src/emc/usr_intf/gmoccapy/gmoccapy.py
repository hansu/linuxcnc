...
#            print dro.name
    ...
    def _init_preferences(self):
        ...
        if self.rapid_override_max < 1.0:
            self.rapidrate = self.rapid_override_max
            self.command.rapidrate(self.rapidrate)
        self.widgets.spc_rapid.set_value(self.rapidrate * 100)
