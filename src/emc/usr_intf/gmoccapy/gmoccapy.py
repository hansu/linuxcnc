    ...
    def _set_icon_theme(self, name):
        ...
        if name is None or name == "none":
            ...
            icon_configs = [
                ...
                ("img_settings", "preferences-system_inactive", 48),
                ("img_settings_on", "preferences-system_active", 48),
                ...
                ("img_zoom_in", "zoom-in", 24),
                ("img_zoom_out", "zoom-out", 24),
                ("img_tool_clear", "edit-clear", 24),
                ...
                # fullscreen
                ("img_fullsize_preview0_open",  "view-fullscreen",   48),
                ("img_fullsize_preview0_close", "view-nofullscreen", 48),
                ("img_fullsize_preview1_open",  "view-fullscreen",   48),
                ("img_fullsize_preview1_close", "view-nofullscreen", 48),
                # ref
                ("img_ref_menu",            "ref_all",          48),
                ("img_ref_menu_close",      "edit-undo",        32),
                ("img_ref_paginate_next",   "go-previous",      32),
                ("img_ref_paginate_prev",   "go-next",          32),
                ...
                ("img_touch_menu_close",    "edit-undo",   32),
                ("img_touch_paginate_next", "go-next",     32),
                ("img_touch_paginate_prev", "go-previous", 32),
                ...
                ("img_back_tool",   "edit-undo",            32),
                ("img_tool_by_no",  "mill_tool_change_num", 48),
                ("img_index_tool",  "mill_tool_set_num",    48),
                # auto mode buttons
                ("img_open",            "document-open",                   32),
                ("img_reload1",         "view-refresh",                    32),
                ("img_run",             "media-playback-start",            32),
                ("img_stop",            "process-stop",                    32),
                ("img_pause",           "media-playback-pause",            32),
                ("img_pause_active",    "media-playback-pause_active",     32),
                ("img_step",            "media-skip-forward",              32),
                ("img_run_from",        "run_from_line",                   48),
                ("img_editor",          "accessories-text-editor",         32),
                ("img_skip_optional_active",    "skip_optional_active",    32),
                ("img_skip_optional_inactive",  "skip_optional_inactive",  32),
                # load file buttons
                ("img_home",            "go-home",              32),
                ("img_dir_up",          "go-up",                32),
                ("img_sel_prev",        "go-previous",          32),
                ("img_sel_next",        "go-next",              32),
                ("img_jump_to",         "go-jump",              32),
                ("img_select",          "select_file",          32),
                ("img_back_file_load",  "edit-undo",            32),
                # edit file menu
                ("img_edit_menu_reload",        "view-refresh",        32),
                ("img_edit_menu_save",          "document-save",       32),
                ("img_edit_menu_save_as",       "document-save-as",    32),
                ("img_edit_menu_new",           "document-new",        32),
                ("img_edit_menu_keyboard",      "input-keyboard",      32),
                ("img_edit_menu_keyboard_hide", "input-keyboard_hide", 32),
                ("img_edit_menu_close",         "edit-undo",           32),
                # macro menu
                ("img_macro_menu_keyboard",         "input-keyboard",      32),
                ("img_macro_menu_keyboard_hide",    "input-keyboard_hide", 32),
                ("img_macro_menu_stop",             "process-stop",        32),
                # misc
                ("img_close", "application-exit", 48),
            ]
